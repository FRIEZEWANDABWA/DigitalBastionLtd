...
import { ExternalLink, Calendar, Users, Shield } from 'lucide-react'
...
export default function Portfolio() {
  const projects = [
    ...
    },
    {
      ...
      description: 'Rapid response to security breach with full system recovery and enhanced protection measures.',
      results: ['24-hour full recovery', 'Enhanced security posture', 'Business continuity maintained'],
    ...
    },
    {
      ...
      image: '/images/pexels-timmossholder-942317.jpg',
      description: 'Secured IoT infrastructure with device authentication, network segmentation, and monitoring.',
      results: ['100% device visibility', 'Automated threat detection', 'Scalable security framework'],
    ...
    },
    {
      ...
      image: '/images/pexels-michael-burrows-7129654.jpg',
      description: 'Comprehensive penetration testing and vulnerability assessment with remediation guidance.',
      results: ['Critical vulnerabilities identified', 'Security roadmap delivered', 'Investor confidence increased'],
